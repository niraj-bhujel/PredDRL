...
#include<preddrl_msgs/TrackedPersons.h>
#include<preddrl_msgs/AgentStates.h>
...
namespace gazebo
{
    class ActorPosesPlugin : public WorldPlugin{
        ...
        void Load(physics::WorldPtr _world, sdf::ElementPtr _sdf){
            ...
            ros::SubscribeOptions so = ros::SubscribeOptions::create<preddrl_msgs::AgentStates>("/preddrl_tracker/ped_states", 1,boost::bind(&ActorPosesPlugin::OnRosMsg, this, _1), ros::VoidPtr(),&rosQueue);
        ...
        public:
            ...
            void OnRosMsg( const preddrl_msgs::AgentStatesConstPtr msg) {
//              ROS_INFO ("OnRosMsg ... ");
