...
class DDPG(OffPolicyAgent):
    ...
    def _train_body(self, states, actions, next_states, rewards, dones, weights):
        ...
        # Optimize the critic
        self.optimization_step(self.critic_optimizer, critic_loss, model=self.critic, clip_norm=1.0)
        ...
        # Optimize the actor 
        self.optimization_step(self.actor_optimizer, actor_loss, model=self.actor, clip_norm=1.0)
